...
from capstoneProj.objects.character import Stats
from capstoneProj.objects.item import (
    AttackerStartingItem,
    DefenderStartingItem,
    FocusStartingItem,
)
from capstoneProj.systems.battle.damage_calculator import DamageCalculationConfig
from capstoneProj.systems.battle.enemy_scaling import (
...
class RPGConfig:
    ...
    def damage_calculation(self) -> DamageCalculationConfig:
        return DamageCalculationRPGConfig(
